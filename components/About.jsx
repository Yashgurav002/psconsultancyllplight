  ...
  return (
    <section id="about" className="relative py-24 md:py-32 overflow-hidden">
      ...
      <div className="absolute inset-0"
        style={{ background: 'radial-gradient(ellipse 60% 50% at 80% 50%, rgba(21,128,61,0.06) 0%, transparent 65%)' }}
      />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-3 mb-16">
          ...
          <span className="text-pitch-500 text-xs font-heading font-semibold tracking-widest uppercase">About the Founder</span>
            ...
            <div className="relative">
              ...
              <div className="relative w-full max-w-sm mx-auto lg:mx-0">
                ...
                <div className="relative glass rounded-2xl p-1 overflow-hidden">
                  ...
                  >
                    {/* Gradient placeholder portrait */}
                    <div className="absolute inset-0 bg-gradient-to-br from-pitch-900 via-dark-700 to-pitch-950" />
                    <div className="absolute inset-0 flex flex-col items-center justify-center">
                      {/* Silhouette */}
                      <div className="w-24 h-24 rounded-full bg-pitch-700/40 border-2 border-pitch-600/40 mb-4 flex items-center justify-center">
                        <svg className="w-12 h-12 text-pitch-500" fill="currentColor" viewBox="0 0 24 24">
                          <path d="M12 12c2.7 0 4.8-2.1 4.8-4.8S14.7 2.4 12 2.4 7.2 4.5 7.2 7.2 9.3 12 12 12zm0 2.4c-3.2 0-9.6 1.6-9.6 4.8v2.4h19.2v-2.4c0-3.2-6.4-4.8-9.6-4.8z"/>
                        </svg>
                      </div>
                      <div className="text-pitch-400 font-heading font-bold text-xl">HARDIK SHETH</div>
                      <div className="text-gray-500 text-sm mt-1">Founder & Director</div>
                    </div>
                    {/* Corner detail */}
                ...
                <div className="absolute -right-4 top-8 glass-gold rounded-xl px-4 py-2.5 shadow-xl">
                  <div className="text-gold-400 font-heading font-bold text-sm">Real Madrid</div>
                  <div className="text-gray-400 text-xs">Graduate School Alumni</div>
                </div>

                <div className="absolute -left-4 bottom-12 glass rounded-xl px-4 py-2.5 shadow-xl">
                  <div className="text-pitch-400 font-heading font-bold text-sm">Spanish Methodology</div>
                  <div className="text-gray-400 text-xs">Certified Specialist</div>
                </div>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div className="grid sm:grid-cols-2 gap-4 mb-10">
              <div className="glass rounded-xl p-5 border-l-2 border-pitch-600">
                <div className="text-pitch-400 font-heading font-bold text-xs tracking-wider uppercase mb-2">Our Vision</div>
              ...
              <div className="glass rounded-xl p-5 border-l-2 border-gold-500">
                <div className="text-gold-400 font-heading font-bold text-xs tracking-wider uppercase mb-2">Our Mission</div>
                <p className="text-gray-300 text-sm font-body leading-relaxed">
            ...
            <div className="grid grid-cols-2 gap-3">
              {values.map((val, i) => (
                <div key={i} className="flex items-start gap-3 group">
                  <div className="w-8 h-8 rounded-lg bg-pitch-950/60 border border-pitch-800/40 flex items-center justify-center text-pitch-500 flex-shrink-0 group-hover:border-pitch-600 group-hover:text-pitch-400 transition-colors">
                    {val.icon}
                  </div>
                  <div>
                    <div className="font-heading font-semibold text-white text-sm mb-0.5">{val.title}</div>
                    <div className="text-gray-500 text-xs font-body leading-relaxed">{val.desc}</div>
                  </div>
                </div>
              ))}
            </div>
